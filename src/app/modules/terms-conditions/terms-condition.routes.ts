...
import { TermsCOnditionsController } from './terms-condition.controller';
import { TermsCOnditonsValidation } from './terms-condition.validation';
...
router.post(
  ...
  validation(TermsCOnditonsValidation.create),
  TermsCOnditionsController.createTermaConditons,
);
 ...
 *                     updatedAt: "2025-08-12T10:30:00.000Z"
 */
router.get('/', TermsCOnditionsController.getTermsConditons);
...
router.put(
  '/',
  auth([featureNames.otherPageSetup]),
  validation(TermsCOnditonsValidation.update),
  TermsCOnditionsController.updateTermsConditions,
);

export const TermsConditonsRoutes = router;
